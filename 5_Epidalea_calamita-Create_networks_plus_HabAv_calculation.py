...
run_name = "Epcal" #The name that will be given to the output files.
...
# the above function
d0 = 332 # Median dispersal distance, specify for each species depending on reported max. disp. dist., corresponding to max. cost distance in the following explanation:
...
patchCodeRast = "C:\\Users\\damiano\\Documents\\PhD\\Additional_species_runs\\Network_setup\\habPatchCode_Epcal1.tif"
habPatchCode = Raster(patchCodeRast)

arcpy.RasterToPolygon_conversion(habPatchCode, "habPatchCode_Epcal1.shp", "NO_SIMPLIFY", "VALUE") #Change raster to polygon
arcpy.Dissolve_management("habPatchCode_Epcal1.shp", "habPatchCode_Epcal1_Diss.shp", "GRIDCODE", "", "MULTI_PART", "") #Disolve the polygons based on the patch code
arcpy.FeatureToPoint_management("habPatchCode_Epcal1_Diss.shp", "habPatchCode_Epcal1_Cntrd.shp", "INSIDE") #Find the centroid of all the patches.
arcpy.AddXY_management ("habPatchCode_Epcal1_Cntrd.shp") #Add the X and Y coordinates of each centroid to the attribute table
...
with arcpy.da.SearchCursor("C:\\Users\\damiano\\Documents\\PhD\\Additional_species_runs\\Networks\\habPatchCode_Epcal1_Cntrd.shp", fields) as cursor:
    for row in cursor:
...
H_CDgraph = ig.Graph.Read_GraphML("Epcal.graphml")
habPatchCode = "C:\\Users\\damiano\\Documents\\PhD\\Additional_species_runs\\Network_setup\\habPatchCode_Epcal1.tif"
...
np.savetxt('Epcal_habAv.txt', habAv, fmt='%.10f')
