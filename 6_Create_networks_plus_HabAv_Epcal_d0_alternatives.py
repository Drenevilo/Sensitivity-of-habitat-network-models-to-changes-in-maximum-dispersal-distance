#-------------------------------------------------------------------------------
# Name:        Create_networks_plus_HabAv_Epcal_d0_alternatives
...
#
# 1st version created:     10-11-2021
...
run_name = "Epcal_4KmDispDist" #The name that will be given to the output files
...
# [Done]     4Km:       d0 = 301 -> Max.Disp.dist. = 3999.601426    #The last one to be processed, which is why this distance is in the script
...
arcpy.RasterToPolygon_conversion(habPatchCode, "habPatchCode_Epcal_4KmDispDist.shp", "NO_SIMPLIFY", "VALUE") #Change raster to polygon
arcpy.Dissolve_management("habPatchCode_Epcal_4KmDispDist.shp", "habPatchCode_Epcal_4KmDispDist_Diss.shp", "GRIDCODE", "", "MULTI_PART", "") #Disolve the polygons based on the patch code
arcpy.FeatureToPoint_management("habPatchCode_Epcal_4KmDispDist_Diss.shp", "habPatchCode_Epcal_4KmDispDist_Cntrd.shp", "INSIDE") #Find the centroid of all the patches.
arcpy.AddXY_management ("habPatchCode_Epcal_4KmDispDist_Cntrd.shp") #Add the X and Y coordinates of each centroid to the attribute table
...
with arcpy.da.SearchCursor("C:\\Users\\damiano\\Documents\\PhD\\Sensitivity_DispDist\\Networks\\habPatchCode_Epcal_4KmDispDist_Cntrd.shp", fields) as cursor:
    for row in cursor:
...
H_CDgraph = ig.Graph.Read_GraphML("Epcal_4KmDispDist.graphml")
habPatchCode = "C:\\Users\\damiano\\Documents\\PhD\\Additional_species_runs\\Network_setup\\habPatchCode_Epcal1.tif" #change for species names or codes
...
np.savetxt('Epcal_4KmDispDist_habAv.txt', habAv, fmt='%.10f')
