#-------------------------------------------------------------------------------
# Name:         Bombina_variegata-Create_networks_plus_HabAv_calculation
...
# 1st version created:     02-04-2019
...
run_name = "Bovar" #The name that will be given to the output files.
...
# the above function
d0 = 301 # Median dispersal distance, change for each species
...
#version located in Networks, not Network_setup
patchCodeRast = "C:\\Users\\damiano\\Documents\\PhD\\Additional_species_runs\\Network_setup\\habPatchCode_Bovar1.tif"
#habPatchCode = "E:\\PhD\\Automated_Run_BioCHECNET\\Network_setup\\Proper_EM\\habPatchCode_ProperEM.tif"
habPatchCode = Raster(patchCodeRast)

arcpy.RasterToPolygon_conversion(habPatchCode, "habPatchCode_Bovar1.shp", "NO_SIMPLIFY", "VALUE") #Change raster to polygon
arcpy.Dissolve_management("habPatchCode_Bovar1.shp", "habPatchCode_Bovar1_Diss.shp", "GRIDCODE", "", "MULTI_PART", "") #Disolve the polygons based on the patch code
arcpy.FeatureToPoint_management("habPatchCode_Bovar1_Diss.shp", "habPatchCode_Bovar1_Cntrd.shp", "INSIDE") #Find the centroid of all the patches.
arcpy.AddXY_management ("habPatchCode_Bovar1_Cntrd.shp") #Add the X and Y coordinates of each centroid to the attribute table
...
with arcpy.da.SearchCursor("C:\\Users\\damiano\\Documents\\PhD\\Additional_species_runs\\Networks\\habPatchCode_Bovar1_Cntrd.shp", fields) as cursor:
    for row in cursor:
...
H_CDgraph = ig.Graph.Read_GraphML("Bovar.graphml")
...
np.savetxt('Bovar_habAv.txt', habAv, fmt='%.10f')
