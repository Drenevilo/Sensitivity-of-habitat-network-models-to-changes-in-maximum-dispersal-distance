#-------------------------------------------------------------------------------
# Name:         Alytes_obstetricans-Create_networks_plus_HabAv_calculation
# Purpose:      Edge definition (Generation of networks) + calculation of Habitat availability predictor
# Purpose:      For Alytes obstetricans
...
# 1st version created:     10-04-2019
...
run_name = "Alobs" #The name that will be given to the output files.
...
# the above function
d0 = 113 # Median dispersal distance, specify for each species depending on reported max. disp. dist., corresponding to max. cost distance in the following explanation:
...
patchCodeRast = "C:\\Users\\damiano\\Documents\\PhD\\Additional_species_runs\\Network_setup\\habPatchCode_Alobs1.tif"
habPatchCode = Raster(patchCodeRast)

arcpy.RasterToPolygon_conversion(habPatchCode, "habPatchCode_Alobs1.shp", "NO_SIMPLIFY", "VALUE") #Change raster to polygon
arcpy.Dissolve_management("habPatchCode_Alobs1.shp", "habPatchCode_Alobs1_Diss.shp", "GRIDCODE", "", "MULTI_PART", "") #Disolve the polygons based on the patch code
arcpy.FeatureToPoint_management("habPatchCode_Alobs1_Diss.shp", "habPatchCode_Alobs1_Cntrd.shp", "INSIDE") #Find the centroid of all the patches.
arcpy.AddXY_management ("habPatchCode_Alobs1_Cntrd.shp") #Add the X and Y coordinates of each centroid to the attribute table
...
with arcpy.da.SearchCursor("C:\\Users\\damiano\\Documents\\PhD\\Additional_species_runs\\Networks\\habPatchCode_Alobs1_Cntrd.shp", fields) as cursor:
    for row in cursor:
...
H_CDgraph = ig.Graph.Read_GraphML("Alobs.graphml") 
habPatchCode = "C:\\Users\\damiano\\Documents\\PhD\\Additional_species_runs\\Network_setup\\habPatchCode_Alobs1.tif"
...
np.savetxt('Alobs_habAv.txt', habAv, fmt='%.10f')
