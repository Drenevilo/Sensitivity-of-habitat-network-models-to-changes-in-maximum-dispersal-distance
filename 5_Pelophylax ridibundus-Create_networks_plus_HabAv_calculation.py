#-------------------------------------------------------------------------------
# Name:         Pelophylax ridibundus-Create_networks_plus_HabAv_calculation
# Purpose:      Edge definition (Generation of networks) + calculation of Habitat availability predictor
# Purpose:      For Pelophylax ridibundus
...
run_name = "Perid" #The name that will be given to the output files.
...
patchCodeRast = "C:\\Users\\damiano\\Documents\\PhD\\Additional_species_runs\\Network_setup\\habPatchCode_Perid1.tif"
habPatchCode = Raster(patchCodeRast)

arcpy.RasterToPolygon_conversion(habPatchCode, "habPatchCode_Perid1.shp", "NO_SIMPLIFY", "VALUE") #Change raster to polygon
arcpy.Dissolve_management("habPatchCode_Perid1.shp", "habPatchCode_Perid1_Diss.shp", "GRIDCODE", "", "MULTI_PART", "") #Disolve the polygons based on the patch code
arcpy.FeatureToPoint_management("habPatchCode_Perid1_Diss.shp", "habPatchCode_Perid1_Cntrd.shp", "INSIDE") #Find the centroid of all the patches.
arcpy.AddXY_management ("habPatchCode_Perid1_Cntrd.shp") #Add the X and Y coordinates of each centroid to the attribute table
...
with arcpy.da.SearchCursor("C:\\Users\\damiano\\Documents\\PhD\\Additional_species_runs\\Networks\\habPatchCode_Perid1_Cntrd.shp", fields) as cursor:
    for row in cursor:
...
H_CDgraph = ig.Graph.Read_GraphML("Perid.graphml")
habPatchCode = "C:\\Users\\damiano\\Documents\\PhD\\Additional_species_runs\\Network_setup\\habPatchCode_Perid1.tif"
...
np.savetxt('Perid_habAv.txt', habAv, fmt='%.10f')
