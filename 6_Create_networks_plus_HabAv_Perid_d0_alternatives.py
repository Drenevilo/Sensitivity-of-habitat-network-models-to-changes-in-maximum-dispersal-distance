#-------------------------------------------------------------------------------
# Name:        Create_networks_plus_HabAv_Perid_d0_alternatives
...
run_name = "Perid_10KmDispDist" #The name that will be given to the output files
...
arcpy.RasterToPolygon_conversion(habPatchCode, "habPatchCode_Perid_10KmDispDist.shp", "NO_SIMPLIFY", "VALUE") #Change raster to polygon
arcpy.Dissolve_management("habPatchCode_Perid_10KmDispDist.shp", "habPatchCode_Perid_10KmDispDist_Diss.shp", "GRIDCODE", "", "MULTI_PART", "") #Disolve the polygons based on the patch code
arcpy.FeatureToPoint_management("habPatchCode_Perid_10KmDispDist_Diss.shp", "habPatchCode_Perid_10KmDispDist_Cntrd.shp", "INSIDE") #Find the centroid of all the patches.
arcpy.AddXY_management ("habPatchCode_Perid_10KmDispDist_Cntrd.shp") #Add the X and Y coordinates of each centroid to the attribute table
...
with arcpy.da.SearchCursor("C:\\Users\\damiano\\Documents\\PhD\\Sensitivity_DispDist\\Networks\\habPatchCode_Perid_10KmDispDist_Cntrd.shp", fields) as cursor:
    for row in cursor:
...
H_CDgraph = ig.Graph.Read_GraphML("Perid_10KmDispDist.graphml")
habPatchCode = "C:\\Users\\damiano\\Documents\\PhD\\Additional_species_runs\\Network_setup\\habPatchCode_Perid1.tif" #change for species names or codes
...
np.savetxt('Perid_10KmDispDist_habAv.txt', habAv, fmt='%.10f')
