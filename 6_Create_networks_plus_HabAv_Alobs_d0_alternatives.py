#-------------------------------------------------------------------------------
# Name:        Create_networks_plus_HabAv_Alobs_d0_alternatives
...
#
# 1st version created:     07-11-2021
...
run_name = "Alobs_8KmDispDist" #The name that will be given to the output files
...
# the above function
d0 = 602 # Median dispersal distance, change for each species
...
# [Done]        8Km:    d0 = 602 -> Max.Disp.dist. = 7999.202852 #The last one to be processed, which is why this distance is in the script
...
arcpy.RasterToPolygon_conversion(habPatchCode, "habPatchCode_Alobs_8KmDispDist.shp", "NO_SIMPLIFY", "VALUE") #Change raster to polygon
arcpy.Dissolve_management("habPatchCode_Alobs_8KmDispDist.shp", "habPatchCode_Alobs_8KmDispDist_Diss.shp", "GRIDCODE", "", "MULTI_PART", "") #Disolve the polygons based on the patch code
arcpy.FeatureToPoint_management("habPatchCode_Alobs_8KmDispDist_Diss.shp", "habPatchCode_Alobs_8KmDispDist_Cntrd.shp", "INSIDE") #Find the centroid of all the patches.
arcpy.AddXY_management ("habPatchCode_Alobs_8KmDispDist_Cntrd.shp") #Add the X and Y coordinates of each centroid to the attribute table
...
with arcpy.da.SearchCursor("C:\\Users\\damiano\\Documents\\PhD\\Sensitivity_DispDist\\Networks\\habPatchCode_Alobs_8KmDispDist_Cntrd.shp", fields) as cursor:
    for row in cursor:
...
H_CDgraph = ig.Graph.Read_GraphML("Alobs_8KmDispDist.graphml")
habPatchCode = "C:\\Users\\damiano\\Documents\\PhD\\Additional_species_runs\\Network_setup\\habPatchCode_Alobs1.tif" #change for species names or codes
...
np.savetxt('Alobs_8KmDispDist_habAv.txt', habAv, fmt='%.10f')
