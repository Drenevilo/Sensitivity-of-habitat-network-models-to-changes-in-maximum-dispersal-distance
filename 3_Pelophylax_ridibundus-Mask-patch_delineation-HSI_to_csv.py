#-------------------------------------------------------------------------------
# Name:         Pelophylax_ridibundus-Mask-patch_delineation-HSI_to_csv
...
# Local variables
binaryHSMap = "C:\\Users\\damiano\\Documents\\PhD\\Additional_species_runs\\HSM\\ROCBin_Auto1st_Perid_ensemble_1.tif"
Mask_Amph_habs = "C:\\Users\\damiano\\Documents\\PhD\\Additional_species_runs\\HSM\\Mask_Amph_habs.tif"
Masked_binaryHSMap = "C:\\Users\\damiano\\Documents\\PhD\\Additional_species_runs\\HSM\\Masked_Pe_rid_ensemble_1_ROCbin.tif"
...
# Save the output
Masked_binaryHSMap.save("C:\\Users\\damiano\\Documents\\PhD\\Additional_species_runs\\HSM\\Masked_Pe_rid_ensemble_1_ROCbin.tif")
...
habPatchCode.save("habPatchCode_Perid1.tif")
...
outDir = u"C:\\Users\\damiano\\Documents\\PhD\\Additional_species_runs\\Presence_absence\\Pe_rid\\Zonal_stats_tables\\"
...
inDir = u"C:\\Users\\damiano\\Documents\\PhD\\Additional_species_runs\\Presence_absence\\Pe_rid\\Zonal_stats_tables\\"
outDir = u"C:\\Users\\damiano\\Documents\\PhD\\Additional_species_runs\\Presence_absence\\Pe_rid\\Zonal_stats_tables\\"
...
Macrotable_csv = "C:\\Users\\damiano\\Documents\\PhD\\Additional_species_runs\\Presence_absence\\Macrotable_Perid.csv"

# Process: Table to Table (to csv)
arcpy.TableToTable_conversion(habPatchCode, Presence_absence_folder, "Macrotable_Perid.csv")
...
HSI_double = "C:\\Users\\damiano\\Documents\\PhD\\Additional_species_runs\\HSM\\Auto1st_Perid_ensemble_1.tif"

filename = Int(HSI_double)
filename.save("C:\\Users\\damiano\\Documents\\PhD\\Additional_species_runs\\HSM\\Auto1st_Perid_ensemble_int.tif")


# #Calculate HSI zonal stats
#vars
habPatchCode = "C:\\Users\\damiano\\Documents\\PhD\\Additional_species_runs\\Network_setup\\habPatchCode_Perid1.tif"
filename = "C:\\Users\\damiano\\Documents\\PhD\\Additional_species_runs\\HSM\\Auto1st_Perid_ensemble_int.tif"
outDBF = "C:\\Users\\damiano\\Documents\\PhD\\Additional_species_runs\\Network_setup\\HSI_habPatchCode_Perid1.dbf"

# # Zonal stats as table
ZonalStatisticsAsTable(habPatchCode, "VALUE", filename, outDBF, "DATA", "ALL")

#Write csv to import into R
arcpy.TableToTable_conversion(outDBF, wrkspc, "HSI_habPatchCode_Perid1.csv")
