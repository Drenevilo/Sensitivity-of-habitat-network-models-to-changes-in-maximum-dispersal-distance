#-------------------------------------------------------------------------------
# Name:        Create_networks_plus_HabAv_Peagg_d0_alternatives
...
# Purpose:     for Pelophylax agg. (esculentus + lessonae)
...
#
# 1st version created:     11-11-2021
...
run_name = "Peagg_10KmDispDist" #The name that will be given to the output files
...
arcpy.RasterToPolygon_conversion(habPatchCode, "habPatchCode_Peagg_10KmDispDist.shp", "NO_SIMPLIFY", "VALUE") #Change raster to polygon
arcpy.Dissolve_management("habPatchCode_Peagg_10KmDispDist.shp", "habPatchCode_Peagg_10KmDispDist_Diss.shp", "GRIDCODE", "", "MULTI_PART", "") #Disolve the polygons based on the patch code
arcpy.FeatureToPoint_management("habPatchCode_Peagg_10KmDispDist_Diss.shp", "habPatchCode_Peagg_10KmDispDist_Cntrd.shp", "INSIDE") #Find the centroid of all the patches.
arcpy.AddXY_management ("habPatchCode_Peagg_10KmDispDist_Cntrd.shp") #Add the X and Y coordinates of each centroid to the attribute table
...
with arcpy.da.SearchCursor("C:\\Users\\damiano\\Documents\\PhD\\Sensitivity_DispDist\\Networks\\habPatchCode_Peagg_10KmDispDist_Cntrd.shp", fields) as cursor:
    for row in cursor:
...
H_CDgraph = ig.Graph.Read_GraphML("Peagg_10KmDispDist.graphml")
habPatchCode = "C:\\Users\\damiano\\Documents\\PhD\\Additional_species_runs\\Network_setup\\habPatchCode_Peagg1.tif" #change for species names or codes
...
np.savetxt('Peagg_10KmDispDist_habAv.txt', habAv, fmt='%.10f')
